...
echo "<tr bgcolor = white><td><font color = black size = '4'>Phone Number: </font>";
echo "<input name=\"phonenumber\" type=\"text\" value= \"\" size=\"12\" maxlength=\"12\" /></td></tr>";
...
if (isset($_POST['submitInfo'])) {
    ...
    if (strlen($_POST['password']) < 6) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            $query = "INSERT INTO seller (name, emailaddress, password, phonenumber, address, city, state, zip, isdeleted)VALUES('" . $name . "','" . $newUsername . "','" . $newPass . "','" . $phonenumber . "', '" . $address . "', '" . $city . "', '" . $state . "', '" . $zip . "', '0')";
